 ...
 */
public class ListaNotasForm extends javax.swing.JInternalFrame {
    ...
    private int nivel;
    /**
     * Creates new form ListaNotasForm
     */
    public ListaNotasForm(int id) {
        initComponents();
    ...
    void buscar(){   
        ...
        ArrayList<Nota> lista = ca.ListarNotasAlumno(asignatura_id);
        modelo = (DefaultTableModel)tabla.getModel();
        Object[] ob = new Object[2];
        for (int i = 0;i < lista.size(); i++){
            ob[0] = lista.get(i).getTrimestre();
            ob[1] = lista.get(i).getNota();
            modelo.addRow(ob);
        }
